...
// #region agent log
fetch('http://127.0.0.1:7242/ingest/3db00b4a-e148-4232-960d-37213473bd9b',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({runId:'pre-fix',hypothesisId:'H1',location:'settings.js:bind-msft-add',message:'Binding settingsAddMicrosoftAccount onclick',data:{exists:document.getElementById('settingsAddMicrosoftAccount') != null},timestamp:Date.now()})}).catch(()=>{});
// #endregion
            ...
            <div class="settingsAuthAccountRight">
                <div class="settingsAuthAccountDetails">
                    ...
                    <div class="settingsAuthAccountDetailPane">
                        ...
                        <div class="settingsAuthAccountDetailValue" style="display:flex;align-items:center;gap:6px">
                            <span data-uuid="${acc.uuid}" data-visible="false" style="font-family:monospace;letter-spacing:1px">${'\u2022'.repeat(acc.uuid.length)}</span>
                            <button onclick="toggleUuidVisibility(this)" style="background:none;border:none;cursor:pointer;font-size:13px;padding:0 3px;color:rgba(255,255,255,0.55);line-height:1">&#128065;</button>
                        </div>
                    </div>
                </div>
