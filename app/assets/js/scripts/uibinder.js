...
async function showMainUI(data){
    ...
    setTimeout(() => {
        ...
        try {
            const { LoggerUtil } = require('helios-core')
            const lg = LoggerUtil.getLogger('UIBinder')
            const mainEl = document.getElementById('main')
            const landingEl = document.getElementById('landingContainer')
            lg.info('UIBinder: #main shown', { mainDisplay: mainEl ? getComputedStyle(mainEl).display : null, landingExists: !!landingEl })
        } catch { /* best effort */ }
